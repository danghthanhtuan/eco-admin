...
import { DeleteTrademarksModalComponent } from './components/delete-trademarks-modal.component';
import { AddTrademarksModalComponent } from './components/add-trademarks-modal.component';
...
export class TrademarksComponent
 ...
 // IDeleteAction,
  ...
  constructor(
    ...
    public tradeService : TrademarksService
  ) { }
  ...
  filter() {
    ...
    // }
    this.tradeService.patchState({ filter });
  }
  ...
  */
  ...
  search(searchTerm: string) {
    this.tradeService.patchState({ searchTerm });
  }
  ...
  sort(column: string) {
    ...
    this.tradeService.patchState({ sorting });
  }

  // pagination
  paginate(paginator: PaginatorState) {
    this.tradeService.patchState({ paginator });
  }
  // actions
