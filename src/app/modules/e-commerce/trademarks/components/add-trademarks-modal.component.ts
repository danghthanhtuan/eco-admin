...
@Component({
  selector: 'app-add-trademarks-modal',
  templateUrl: './add-trademarks-modal.component.html',
  styleUrls: []
})
export class AddTrademarksModalComponent implements OnInit, OnDestroy {
  ...
  loadForm() {
    this.formGroup = this.fb.group({
      target: [this.slide.url, Validators.compose([ Validators.minLength(1), Validators.maxLength(200)])],
  ...
  AddSlide() {
    ...
    var modelPost = new FormData ();
     ...
     modelPost.append('Url',   this.slide.url);
